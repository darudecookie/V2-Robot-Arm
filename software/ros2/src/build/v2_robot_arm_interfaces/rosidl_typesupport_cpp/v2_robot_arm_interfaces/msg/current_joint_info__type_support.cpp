...
static const _CurrentJointInfo_type_support_symbol_names_t _CurrentJointInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2_robot_arm_interfaces, msg, CurrentJointInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, v2_robot_arm_interfaces, msg, CurrentJointInfo)),
  }
};
...
{
  return &::v2_robot_arm_interfaces::msg::rosidl_typesupport_cpp::CurrentJointInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, v2_robot_arm_interfaces, msg, CurrentJointInfo)() {
  return get_message_type_support_handle<v2_robot_arm_interfaces::msg::CurrentJointInfo>();
}
