...
static const _CurrentCartesian_type_support_symbol_names_t _CurrentCartesian_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, v2_robot_arm_interfaces, msg, CurrentCartesian)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, v2_robot_arm_interfaces, msg, CurrentCartesian)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, v2_robot_arm_interfaces, msg, CurrentCartesian)() {
  return &::v2_robot_arm_interfaces::msg::rosidl_typesupport_c::CurrentCartesian_message_type_support_handle;
}
