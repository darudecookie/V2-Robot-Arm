...
static const _CurrentEEInfo_type_support_symbol_names_t _CurrentEEInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, v2_robot_arm_interfaces, msg, CurrentEEInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, v2_robot_arm_interfaces, msg, CurrentEEInfo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, v2_robot_arm_interfaces, msg, CurrentEEInfo)() {
  return &::v2_robot_arm_interfaces::msg::rosidl_typesupport_c::CurrentEEInfo_message_type_support_handle;
}
