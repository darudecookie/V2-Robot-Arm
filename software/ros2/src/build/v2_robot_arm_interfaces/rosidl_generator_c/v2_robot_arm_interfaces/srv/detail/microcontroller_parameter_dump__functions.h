...
#ifndef V2_ROBOT_ARM_INTERFACES__SRV__DETAIL__MICROCONTROLLER_PARAMETER_DUMP__FUNCTIONS_H_
#define V2_ROBOT_ARM_INTERFACES__SRV__DETAIL__MICROCONTROLLER_PARAMETER_DUMP__FUNCTIONS_H_
...
/// Initialize srv/MicrocontrollerParameterDump message.
/**
 ...
 * )) before or use
 * v2_robot_arm_interfaces__srv__MicrocontrollerParameterDump_Request__create()
...
/// Finalize srv/MicrocontrollerParameterDump message.
/**
...
/// Create srv/MicrocontrollerParameterDump message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * v2_robot_arm_interfaces__srv__MicrocontrollerParameterDump_Request__init().
...
/// Destroy srv/MicrocontrollerParameterDump message.
/**
 * It calls
 * v2_robot_arm_interfaces__srv__MicrocontrollerParameterDump_Request__fini()
...
/// Check for srv/MicrocontrollerParameterDump message equality.
/**
...
/// Copy a srv/MicrocontrollerParameterDump message.
/**
...
/// Initialize array of srv/MicrocontrollerParameterDump messages.
/**
...
/// Finalize array of srv/MicrocontrollerParameterDump messages.
/**
 * It calls
 * v2_robot_arm_interfaces__srv__MicrocontrollerParameterDump_Request__fini()
...
/// Create array of srv/MicrocontrollerParameterDump messages.
/**
 * It allocates the memory for the array and calls
 * v2_robot_arm_interfaces__srv__MicrocontrollerParameterDump_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MicrocontrollerParameterDump messages.
/**
 * It calls
 * v2_robot_arm_interfaces__srv__MicrocontrollerParameterDump_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/MicrocontrollerParameterDump message array equality.
/**
...
/// Copy an array of srv/MicrocontrollerParameterDump messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * v2_robot_arm_interfaces__srv__MicrocontrollerParameterDump_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_v2_robot_arm_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * v2_robot_arm_interfaces__srv__MicrocontrollerParameterDump_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_v2_robot_arm_interfaces
...
/**
 * It calls
 * v2_robot_arm_interfaces__srv__MicrocontrollerParameterDump_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_v2_robot_arm_interfaces
...
/**
 * It allocates the memory for the array and calls
 * v2_robot_arm_interfaces__srv__MicrocontrollerParameterDump_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_v2_robot_arm_interfaces
...
/**
 * It calls
 * v2_robot_arm_interfaces__srv__MicrocontrollerParameterDump_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * v2_robot_arm_interfaces__srv__MicrocontrollerParameterDump_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_v2_robot_arm_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * v2_robot_arm_interfaces__srv__MicrocontrollerParameterDump_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_v2_robot_arm_interfaces
...
/**
 * It calls
 * v2_robot_arm_interfaces__srv__MicrocontrollerParameterDump_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_v2_robot_arm_interfaces
...
/**
 * It allocates the memory for the array and calls
 * v2_robot_arm_interfaces__srv__MicrocontrollerParameterDump_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_v2_robot_arm_interfaces
...
/**
 * It calls
 * v2_robot_arm_interfaces__srv__MicrocontrollerParameterDump_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // V2_ROBOT_ARM_INTERFACES__SRV__DETAIL__MICROCONTROLLER_PARAMETER_DUMP__FUNCTIONS_H_
