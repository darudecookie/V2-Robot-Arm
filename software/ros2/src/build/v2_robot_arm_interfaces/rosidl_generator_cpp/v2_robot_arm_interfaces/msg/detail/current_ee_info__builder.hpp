...
class Init_CurrentEEInfo_current_end_effector_bool
{
public:
  explicit Init_CurrentEEInfo_current_end_effector_bool(::v2_robot_arm_interfaces::msg::CurrentEEInfo & msg)
  : msg_(msg)
  {}
  ::v2_robot_arm_interfaces::msg::CurrentEEInfo current_end_effector_bool(::v2_robot_arm_interfaces::msg::CurrentEEInfo::_current_end_effector_bool_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_CurrentEEInfo_current_end_effector_bool current_end_effector_value(::v2_robot_arm_interfaces::msg::CurrentEEInfo::_current_end_effector_value_type arg)
  {
    msg_.current_end_effector_value = std::move(arg);
    return Init_CurrentEEInfo_current_end_effector_bool(msg_);
  }
