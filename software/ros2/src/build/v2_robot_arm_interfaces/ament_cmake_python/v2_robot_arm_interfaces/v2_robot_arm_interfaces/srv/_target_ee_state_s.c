...
bool v2_robot_arm_interfaces__srv__target_ee_state__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // target_end_effector_bool
    PyObject * field = PyObject_GetAttrString(_pymsg, "target_end_effector_bool");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->target_end_effector_bool = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
PyObject * v2_robot_arm_interfaces__srv__target_ee_state__request__convert_to_py(void * raw_ros_message)
{
  ...
  {  // target_end_effector_bool
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->target_end_effector_bool);
    {
      int rc = PyObject_SetAttrString(_pymessage, "target_end_effector_bool", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
