...
class Metaclass_CurrentEEInfo(type):
    """Metaclass of message 'CurrentEEInfo'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'v2_robot_arm_interfaces.msg.CurrentEEInfo')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__current_ee_info
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__current_ee_info
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__current_ee_info
            cls._TYPE_SUPPORT = module.type_support_msg__msg__current_ee_info
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__current_ee_info
...
class CurrentEEInfo(metaclass=Metaclass_CurrentEEInfo):
    """Message class 'CurrentEEInfo'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.current_end_effector_bool = kwargs.get(
            'current_end_effector_bool', CurrentEEInfo.CURRENT_END_EFFECTOR_BOOL__DEFAULT)
