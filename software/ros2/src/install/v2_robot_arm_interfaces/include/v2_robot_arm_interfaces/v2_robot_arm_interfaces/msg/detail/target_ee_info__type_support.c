...
static rosidl_typesupport_introspection_c__MessageMember v2_robot_arm_interfaces__msg__TargetEEInfo__rosidl_typesupport_introspection_c__TargetEEInfo_message_member_array[2] = {
  {
    "header",  // name
