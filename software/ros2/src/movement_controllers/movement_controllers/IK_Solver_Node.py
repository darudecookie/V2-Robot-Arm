...
class IK_Controller(Node):
    def __init__(self):
        ...
        self.Current_Status_sub = self.create_subscription(ControlStatus, "control_status", self.recieve_output_status, 10)

        self.Current_Joint_sub = self.create_subscription(CurrentJointInfo, "current_joint_information", self.recieve_current_joint_angles, 10)
        ...
        self.Target_Cartesian_sub = self.create_subscription(TargetCartesian, "target_cartesian", self.recieve_target_cartesian, 10)


        self.IK_Calc_frequency = 200
        self.IK_timer = self.create_timer(1/self.IK_Calc_frequency, self.calulate_IK_publish_JointAngles)


    def recieve_output_status(self, msg):
        if msg.ik_solver == 1:
    ...
    def recieve_current_joint_angles(self, msg):
    ...
    def recieve_target_cartesian(self, msg):
    ...
    def calulate_IK_publish_JointAngles(self):
